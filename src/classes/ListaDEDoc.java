...
public class ListaDEDoc {
    ...
    /*PROVAVELMENTE, não vamos precisar imprimir os documentos isoladamente */
    /*public String toString() {
        String imprime = "==============/ Documentos Armazenados /==============";
        ElementoDoc aux = inicio;
        while (aux != null) {
            imprime += "ID do documento: " + aux.dado.Id + "\nNome do Documento: " + aux.dado.titulo;
